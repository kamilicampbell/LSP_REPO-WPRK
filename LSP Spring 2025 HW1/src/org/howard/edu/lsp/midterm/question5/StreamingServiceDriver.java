...
//The StreamingServiceDriver class tests the functionality of the media types (Music, Movie, Audiobook).
public class StreamingServiceDriver {
    public static void main(String[] args) {
        //Creates instances of different media types
        ...
        //Tests the common behaviors for all media types (e.g. play, pause, stop)
        ...
        //Tests unique behaviors for each media type
